...
PLUGINS="one-click-demo-import akismet all-in-one-seo-pack contact-form-7 flamingo jetpack stops-core-theme-and-plugin-updates sucuri-scanner tesla-login-customizer tinymce-advanced w3-total-cache woocommerce wordpress-importer wordpress-seo wp-smushit wp-super-cache yith-woocommerce-ajax-navigation yith-woocommerce-compare yith-woocommerce-quick-view yith-woocommerce-wishlist remove-query-strings-from-static-resources better-wp-security tiny-compress-images under-construction-page"
